...
#^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    def run(self, T, dt=0.1, checkpoints=None, verbose=True):
...
#^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    def figure_infections(self, plot_S=False, plot_E=False, plot_I='stacked',plot_R=False, plot_F=False,
                            ...
                            shaded_reference_results=None, shaded_reference_label='reference', 
                            vlines=[], vline_colors=[], vline_styles=[], vline_labels=[],
                            ylim=None, xlim=None, legend=False, title=None, side_title=None, plot_percentages=True,
                            figsize=(12,8), use_seaborn=True, show=True):
...
#^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^     
    ...
    def run_iteration(self):
        ...
        if(propensities.sum() > 0):
            ...
            self.timer_state[transitionNode] = 0.01
...
#^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
    ...
    def figure_basic_1227(self, plot_S=False, plot_E=False, plot_I_pre='line', plot_I_sym='line', plot_I_asym='line',
                         plot_H=False, plot_R=False, plot_F=False,
                         plot_Q_E=False, plot_Q_pre=False, plot_Q_sym=False, plot_Q_asym=False,
                         plot_Q_S=False, plot_Q_R=False, combine_Q_infected=False,
                         color_S='tab:green', color_E='orange', color_I_pre='crimson', color_I_sym='tomato',
                         color_I_asym='#F0909B',
                         color_H='violet', color_R='tab:blue', color_F='black',
                         color_Q_E='orange', color_Q_pre='tomato', color_Q_sym='crimson', color_Q_asym='#F0909B',
                         color_Q_S='tab:green', color_Q_R='tab:blue', color_Q_infected='tab:purple',
                         ...
                         shaded_reference_results=None, shaded_reference_label='reference',
                         vlines=[], vline_colors=[], vline_styles=[], vline_labels=[],
                         ylim=None, xlim=None, legend=None, title=None, side_title=None, plot_percentages=True,
                         figsize=(12, 8), use_seaborn=True, show=True):
